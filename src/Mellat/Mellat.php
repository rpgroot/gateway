...
class Mellat extends PortAbstract implements PortInterface
{
    ...
    {
        if (!$this->callbackUrl)
            $this->callbackUrl = $this->config->get($this->confpath);
    ...
    protected function sendPayRequest()
    {
        ...
        $fields = array(
            'terminalId' => $this->config->get($this->confpath.'.terminalId'),
            'userName' => $this->config->get($this->confpath.'username'),
            'userPassword' => $this->config->get($this->confpath.'password'),
